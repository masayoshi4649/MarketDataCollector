...
| 503 | `PROVIDER_UNAVAILABLE` | Python依存・出力を含むprovider実行環境、J-QuantsのAPIキー・契約・レート制限、Polymarketの429等により利用不能 |
| 504 | `TIMEOUT` | 収集期限を超過 |
